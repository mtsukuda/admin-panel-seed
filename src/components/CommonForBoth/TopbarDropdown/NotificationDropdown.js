...
class NotificationDropdown extends Component {
  ...
  fetchNotifications() {
    ...
    // const document = firestore.doc('Ta1gaYZA8WXwsQpK7lG9dezs09l1/notifications');
      ...
      <React.Fragment>
        ...
        >
          <DropdownToggle
            ...
            <span className="badge badge-danger badge-pill">99</span>
          </DropdownToggle>
            ...
            <div className="p-3">
              <Row className="align-items-center">
                ...
                <div className="col-auto">
                  <a href="#!" className="small"> {this.props.t('View All')}</a>
                </div>
              </Row>
            </div>
