...
class LanguageDropdown extends Component {
  ...
  changeLanguageAction = (lng) => {
    ...
    if(lng === "sp")
      ...
      this.setState({lng : "日本語", flag : japan });
  }
      ...
      <React.Fragment>
        ...
        >
          ...
          <DropdownMenu className="language-switch" right>
            ...
            <DropdownItem tag="a" href="#" onClick={() => this.changeLanguageAction('ja')} className={`notify-item ${this.state.lng === 'Japanese' ? 'active' : 'none'}`}>
              <img src={japan} alt="Skote" className="mr-1" height="12" />
