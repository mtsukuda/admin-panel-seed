      ...
      <React.Fragment>
        <Card>
          <CardBody>
            ...
            <div className="text-center mt-4"><Link to="" className="btn btn-primary waves-effect waves-light btn-sm">{this.props.t('View More')} <i className="mdi mdi-arrow-right ml-1"></i></Link></div>
          </CardBody>
        </Card>
      </React.Fragment>
    );
...
export default withNamespaces()(ActivityComp);
