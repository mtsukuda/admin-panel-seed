                      ...
                      <Col md="4" key={"_col_" + key}>
                        <Card className="mini-stats-wid">
                          <CardBody>
                            <Media>
                              <Media body>
                                <p className="text-muted font-weight-medium">{this.props.t(report.title)}</p>
                      ...
                      <ul className="nav nav-pills">
                        {
                          this.state.email.map((mail, key) =>
                            <li className="nav-item" key={"_li_" + key}>
                              <Link className={mail.isActive ? "nav-link active" : "nav-link"} to={mail.linkto}>{this.props.t(mail.title)}</Link>
                            </li>
                          )
                        }
                      </ul>
