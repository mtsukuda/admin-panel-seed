                ...
                <Card>
                    <CardBody>
                        ...
                        <div className="text-center mb-4">
                            ...
                            <Link to="#" className="text-primary font-16">{this.props.t('Learn more')} <i className="mdi mdi-chevron-right"></i></Link>
                        </div>
                        <Row className="mb-1">
                            {
...
export default withNamespaces()(SocialSource);
